...
However, this approach fundamentally cannot achieve the same level of fine-grained management and drift detection as a fully containerized approach, due to the mismatch between the two operational models of Ansible and Kubernetes.
