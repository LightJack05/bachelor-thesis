...
It should be stated that the integration between the two systems is not perfect. Ansible itself notably does not remove configurations that were removed from playbooks from the target, which means the operator also cannot make such changes.
