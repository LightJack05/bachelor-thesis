...
The chapters \ref{ch:theory} and \ref{ch:technical} introduce theoretical and technical concepts required for understanding the basis on which this thesis builds.
Chapter \ref{ch:goals} explains the goals of the thesis and explaining the problem this thesis is attempting to solve.
Chapter \ref{ch:analysis} looks at the market and investigating whether there are already similar solutions available which could be adopted.
