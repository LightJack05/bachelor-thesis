...
Coupling between the \anplaybook and the inventory objects is loose, since only the playbook source references them; all other relations are explicit references between Kubernetes objects.
...
Externally, the operator contacts the \gls{ssh} hosts and may optionally download collections or roles from Ansible galaxy or git servers, as well as the playbook files themselves.
