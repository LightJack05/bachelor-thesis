...
\texttt{Playbooks} should both be able to be inline for easy management within Kubernetes, and be able to be pulled from Git repositories so they can be easier version controlled.
