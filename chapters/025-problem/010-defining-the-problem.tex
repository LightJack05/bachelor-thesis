...
Since the Kubernetes architecture hinges on the individual components providing promises to accept in the form of \glspl{crd}, which are then used by an agent, the controller, to fulfill a promise, and assess whether the promise has been fulfilled, it can be stated that Kubernetes is a promise-based system.
