...
When looking at Ansible and Kubernetes, it becomes clear that their modes of operation differ.
...
Since the Kubernetes architecture hinges on the individual components providing promises to accept in the form of \glspl{crd}, which is then used by an agent, the controller, to fulfill a promise, and asses whether the promise has been fulfilled, we can deductively infer that Kubernetes is a promise based system.
