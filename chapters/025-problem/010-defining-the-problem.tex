...
Both Kubernetes and Ansible attempt to solve this.
In these systems, configurations are stored as files of different formats, which can in turn be stored in a version control system like git.
...
In platform engineering, the list of things possible via the platform is referred to as the \enquote{capability plane}.
