...
When managing this kind of infrastructure, it is essential to allow personnel to have single way of accessing and assessing infrastructure.
...
However, it is important to state that when using multiple such systems, it may again lead to \gls{tribalknowledge}.
...
Since the Kubernetes architecture hinges on the individual components providing promises to accept in the form of \glspl{crd}, which is then used by an agent, the controller, to fulfill a promise, and assess whether the promise has been fulfilled, it can be stated that Kubernetes is a promise based system.
